...
NOTE: At this time it is highly recommended that developers wishing to compile the Rito Core binaries **DO NOT** upgrade to 
...
Use the following commands to compile a working version of Rito Core on Mojave (assuming that the instructions in the section "Build 
Rito Core" has already been followed).  Uninstall Berkeley-db 4.8.3, install the latest version, and _configure_ with the 
