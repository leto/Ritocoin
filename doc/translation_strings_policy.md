...
This document provides guidelines for internationalization of the Rito Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rito_en.ts` remains unchanged.
