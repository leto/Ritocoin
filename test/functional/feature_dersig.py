...
class BIP66Test(RitoTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # ritod is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and ritod produces more specific reject
            # reasons.
