...
By default, ritod will dump mempool on shutdown and
...
class MempoolPersistTest(RitoTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give ritod a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent ritod from writing mempool.dat to disk. Verify that `savemempool` fails")
