...
from test_framework.test_framework import RitoTestFramework, SkipTest
...
class ZMQTest (RitoTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that rito has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("ritod has not been built with zmq enabled.")
