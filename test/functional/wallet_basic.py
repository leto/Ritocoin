...
class WalletTest(RitoTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 RITO from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 RITO with subtract fee from amount
        ...
        # Sendmany 10 RITO with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/RitoProject/Ritocoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
