...
#ifndef RITO_QT_RITOGUI_H
#define RITO_QT_RITOGUI_H
...
/**
  Rito GUI main class. This class represents the main window of the Rito UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class RitoGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit RitoGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~RitoGUI();
