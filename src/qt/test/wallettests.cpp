...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<RitoAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_rito-qt -platform xcb      # Linux
//     src/qt/test/test_rito-qt -platform windows  # Windows
//     src/qt/test/test_rito-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = RitoUnits::formatWithUnit(unit, balance, false, RitoUnits::separatorAlways);
    ...
    // Amount input
    RitoAmountField* amountInput = receiveCoinsDialog.findChild<RitoAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: rito:")) != -1);
