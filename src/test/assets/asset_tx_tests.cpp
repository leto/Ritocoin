...
BOOST_FIXTURE_TEST_SUITE(asset_tx_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_not_valid) {
        ...
        // This should fail because 900 RITO doesn't have a destination
        CAssetTransfer assetTransfer("RITO", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_multiple_assets) {
        ...
        CAssetTransfer asset2("RITOTEST", 1000);
        CScript scriptPubKey2 = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        asset2.ConstructTransaction(scriptPubKey2);

        CAssetTransfer asset3("RITOTESTTEST", 1000);
        ...
        for (int i = 0; i < 10; i++) {
            ...
            CAssetTransfer outAsset2("RITOTEST", 100);
            ...
            // Add the third asset
            CAssetTransfer outAsset3("RITOTESTTEST", 100);
        ...
        // The inputs are spending 3000 Assets (1000 of each RITO, RITOTEST, RITOTESTTEST)
        // The outputs are spending 100 Assets to 10 destinations (10 * 100 = 1000) (of each RITO, RITOTEST, RITOTESTTEST)
