Rito Core integration/staging tree
=====================================
...
Ritocoin is an experimental digital currency that enables instant payments to
anyone, anywhere in the world. Ritocoin uses peer-to-peer technology to operate
...
Rito Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
completely stable. [Tags](https://github.com/RitoProject/Ritocoin/tags) are created
regularly to indicate new official, stable release versions of Rito Core.

The contribution workflow is described in [CONTRIBUTING.md](CONTRIBUTING.md).

The developer [mailing list](https://lists.linuxfoundation.org/mailman/listinfo/rito-dev)
should be used to discuss complicated or controversial changes before working
on a patch set.

Developer IRC can be found on Freenode at #rito-core-dev.
...
Use this command to initially start ritod on the testnet. <code>./ritod -testnet -maxtipage=259200</code>
